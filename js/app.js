$(document).ready(function() {
    ...
    //        var target = e.target;
    //        if (!$(target).is('#Header .menu ul>li>a')) {
...
$(function() {
    ...
    $("#fast>a").keyup(function() {
        $(".fastlink").css({ right: 0 })
        $(".fastlink_btn").css('display', 'none')
        $(".fastlink_btn2").css('display', 'block')
    })
    $('.fastlink').find('li:last>a').focusout(function() {
        $(".fastlink").css({ right: -80 })
        $(".fastlink_btn").css('display', 'block')
        $(".fastlink_btn2").css('display', 'none')
    });
...
$(function() {
    $('.group01').click(function() {
        $('body,html').stop(true, true).animate({ scrollTop: $('.Block2').offset().top }, 1200, 'easeOutExpo');
    });
    $('.group02').click(function() {
        $('body,html').stop(true, true).animate({ scrollTop: $('.Block3').offset().top }, 1200, 'easeOutExpo');
    });
    $('.group03').click(function() {
        $('body,html').stop(true, true).animate({ scrollTop: $('.Block4').offset().top }, 1200, 'easeOutExpo');
    });
    $('.group04').click(function() {
        $('body,html').stop(true, true).animate({ scrollTop: $('.Block5').offset().top }, 1200, 'easeOutExpo');
    });
})
// 影片燈箱區
$(function() {
